...
This is a little helper class I made while going through [these](https://learnopengl.com/) tutorials. Many OpenGL tutorials online implement a first-person shooter (FPS) style camera system for viewport navigation, which I find less flexible compared to an orbit camera system like the ones found in most 3D authoring software.
